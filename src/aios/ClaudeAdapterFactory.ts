...
/**
 * ClaudeAdapterFactory.ts
 * 
 * 決定論的かつ不変な ClaudeAdapter インスタンスを生成するファクトリ。
 * 
 * 警告：本ファイル内への API 通信、コマンド送信、自律改善、AI予測・推論・自動配置ロジックの実装は厳禁である。
 */

export class ClaudeAdapterFactory {
  private static instanceCounter = 0;

  /**
   * 不変な ClaudeAdapter インスタンスを決定論的に生成する
   */
  static create(
    name: string,
    description: string,
    ...
    const id = `adapter-${++ClaudeAdapterFactory.instanceCounter}`;
