import { KnowledgePromotionRuntime } from '../../core/promotion/runtime/KnowledgePromotionRuntime';
import { PromotionStateMachine } from '../../core/promotion/state/PromotionStateMachine';
import { CandidateAssessmentService } from '../../core/promotion/services/CandidateAssessmentService';
import { KnowledgeMergeEngine } from '../../core/promotion/services/KnowledgeMergeEngine';
import { MergePlanner } from '../../core/promotion/services/MergePlanner';
import { ConflictDetector } from '../../core/promotion/services/ConflictDetector';
import { MergeSimulator } from '../../core/promotion/services/MergeSimulator';
import { VersionGenerator } from '../../core/promotion/services/VersionGenerator';
import { LineageUpdater } from '../../core/promotion/services/LineageUpdater';
import { PromotionWriter } from '../../core/promotion/services/PromotionWriter';
import { PromotionEventBus } from '../../core/promotion/observability/PromotionEventBus';
import { PromotionMetrics } from '../../core/promotion/metrics/PromotionMetrics';
import { PromotionLedger, MergeLedger, ConflictLedger, VersionLedger, LineageLedger, AuditLedger, CandidateLedger, KnowledgeLedger } from '../../core/promotion/ledger/PromotionLedger';
import { PromotionCandidate } from '../../core/promotion/models/PromotionCandidate';
