...
(async () => {
  ...
  // Intercept the LIFF SDK request and return an empty script so our initScript's window.liff persists
  await page.route('https://static.line-scdn.net/liff/edge/2/sdk.js', route => {
    route.fulfill({ status: 200, contentType: 'application/javascript', body: 'console.log("Mock LIFF SDK loaded");' });
  });
  ...
  console.log("App visible, switching to settings...");
