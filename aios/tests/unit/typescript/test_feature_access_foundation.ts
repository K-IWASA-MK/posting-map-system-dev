...
import { Role } from '@foundation/authorization/Role';
import { Permission } from '@foundation/authorization/Permission';
import { Scope } from '@foundation/authorization/Scope';
import { AuthorizationContext } from '@foundation/authorization/AuthorizationContext';
import { Edition } from '@foundation/licensing/Edition';
...
import { Feature } from '@foundation/features/Feature';
import { FeatureAvailability } from '@foundation/features/FeatureAvailability';
import { FeaturePolicy } from '@foundation/features/FeaturePolicy';
import { FeatureRegistry } from '@foundation/features/FeatureRegistry';
import { FeatureResolver } from '@foundation/features/FeatureResolver';
