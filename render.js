function renderAreas() {
  ...
  $('area-list').innerHTML = areaSummary.map(s => `
    <div style="background: #0b0b0b; border-radius: 32px; border: 1px solid rgba(255,255,255,0.08); box-shadow: 0 0 20px rgba(37,99,235,0.06);" 
      ...
      <div class="w-3 h-3 rounded-full mr-6 ${s.progress >= 100 ? 'bg-[#22c55e] shadow-[0_0_15px_#22c55e]' : 'bg-[#e11d48]'}"></div>
      <div class="flex-1">
  ...
  if (!userInfo) {
    ...
    container.innerHTML = `
      <div class="flex flex-col items-center justify-center -mt-10 pb-12 px-4">
        ...
        <div class="w-full space-y-8 text-left">
          ...
          <!-- 二重構造 of Button Frame: Match inputs width -->
    ...
    container.innerHTML = `
      <div class="py-10 px-4 flex flex-col items-center">
        ...
        <div style="height: 220px; border-radius: 28px; background: linear-gradient(180deg, rgba(255,255,255,0.02), rgba(255,255,255,0.008)); box-shadow: inset 0 0 0 1px rgba(120,140,255,0.08), 0 0 30px rgba(37,99,235,0.05); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px);" class="w-full flex flex-col items-center justify-center">
