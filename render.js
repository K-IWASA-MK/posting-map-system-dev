  ...
  if (!userInfo) {
    ...
    container.innerHTML = `
      <div class="pt-2 pb-0 px-4 flex flex-col items-center">
        ...
        <div id="id-gyro-card" style="--glow-x: 0px; --glow-y: 0px; --glow-opacity: 0.08; --edge-opacity: 0.08; --edge-angle: 180deg;" class="w-full max-w-sm h-[300px] gyro-card flex flex-col items-center justify-between p-6 relative overflow-hidden cursor-pointer" onclick="openIdInfoModal()">
