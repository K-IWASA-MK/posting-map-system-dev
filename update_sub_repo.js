const fs = require('fs');
const file = '/Volumes/SSD_DATA/posting-map-system/src/infrastructure/repository/workspace/SpreadsheetWorkspaceSubscriptionRepository.ts';
